...
public class QRCodeUtilTest {
    ...
    public static void main(String[] args) throws Exception {
         ...
         * 二维码测试。
         */
        String iconPath = "F:\\Idea背景.jpg";
        String content = "https://wllrx.oss-cn-beijing.aliyuncs.com/zoe/20190830143947.gif";
        File qrCode = new File("F:\\QRCode." + FORMAT);
        File qrCodeWithIcon = new File("F:\\QRCodeWithIcon." + FORMAT);
        // 生成二维码
        ...
        File barCode = new File("F:\\BarCode." + FORMAT);
        // 生成一维码
